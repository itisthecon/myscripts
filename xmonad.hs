...
myBorderWidth = 2
myWorkspaces    = ["\61612","\61554","\61749","\61847","\61691","\61980","\61705","\61564","\62150","\61872"]
...
myManageHook = composeAll . concat $
    ...
    , [className  =? "Vivaldi-stable" --> doShift "\61749"]
    , [className  =? "Com.github.johnfactotum.Foliate" --> doShift "\61564"]
...
myLayout = spacingRaw True (Border 0 2 2 2) True (Border 2 2 2 2) True $ avoidStruts $ mkToggle (NBFULL ?? NOBORDERS ?? EOT) $ tiled ||| Mirror tiled ||| spiral (6/7)  ||| ThreeColMid 1 (3/100) (1/2) ||| Full
    where
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_s), spawn $ "shutter -s" )
  , ((modMask, xK_t), spawn $ "urxvt" )
  , ((modMask, xK_v), spawn $ "pavucontrol" )
  , ((modMask, xK_y), spawn $ "polybar-msg cmd toggle" )
  , ((modMask, xK_x), spawn $ "archlinux-logout" )
  , ((modMask, xK_Escape), spawn $ "xkill" )
  , ((modMask, xK_Return), spawn $ "krunner" )
  ...
  -- FUNCTION KEYS
  , ((0, xK_F1), spawn $ "xfce4-terminal --drop-down --color-bg=#000000 -H -e '/home/ken/.local/share/gem/ruby/3.0.0/bin/mdless /home/ken/keys.md'" )
  ...
  , ((controlMask .|. mod1Mask , xK_a ), spawn $ "alacritty")
  , ((controlMask .|. mod1Mask , xK_b ), spawn $ "thunar")
  , ((controlMask .|. mod1Mask , xK_c ), spawn $ "catfish")
  , ((controlMask .|. mod1Mask , xK_d ), spawn $ "dolphin")
  ...
  , ((controlMask .|. mod1Mask , xK_h ), spawn $ "foliate")
  , ((controlMask .|. mod1Mask , xK_i ), spawn $ "nitrogen")
  , ((controlMask .|. mod1Mask , xK_k ), spawn $ "kitty")
  ...
  , ((controlMask .|. mod1Mask , xK_Return ), spawn $ "xfce4-appfinder")
  , ((controlMask .|. mod1Mask , xK_space ), spawn $ "xfce4-appfinder")
  , ((controlMask .|. mod1Mask , xK_Down ), spawn $ "amixer -q set Master 1%-")
  , ((controlMask .|. mod1Mask , xK_Up ), spawn $ "amixer -q set Master 1%+")
  ...
  , ((mod1Mask, xK_space), spawn $ "krunner" )
...
--  , ((0, xF86XK_AudioStop), spawn $ "mpc stop")
  ...
  -- Swap the focused window with the next window.  , ((controlMask .|. modMask, xK_Down), windows W.swapDown  )
...
, layoutHook = gaps [(U,32), (D,2), (R,2), (L,2)] $ myLayout ||| layoutHook myBaseConfig
