...
config.set('content.proxy', 'http://127.0.0.1:8001')
...
c.fonts.prompts = 'default_size 幼圆'

# Font used in the statusbar.
# Type: Font
#c.fonts.statusbar = '11pt "Source Code Pro"'
c.fonts.statusbar = '11pt "幼圆"'
...
#config.bind('M', 'hint links spawn proxychains4  mpv {hint-url}')
#config.bind('M', 'hint links spawn proxychains4  mpv --force-window=immediate {hint-url}')
config.bind('M', 'hint links spawn ~/.bin/pmpv {hint-url}')
